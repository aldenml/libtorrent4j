...
export CXX=${ANDROID_TOOLCHAIN}/bin/aarch64-linux-android28-clang++
export CC=${ANDROID_TOOLCHAIN}/bin/aarch64-linux-android28-clang
...
${ANDROID_TOOLCHAIN}/bin/llvm-objcopy --only-keep-debug bin/release/android/arm64-v8a/libtorrent4j.so bin/release/android/arm64-v8a/libtorrent4j.so.debug
${ANDROID_TOOLCHAIN}/bin/llvm-strip --strip-unneeded -x bin/release/android/arm64-v8a/libtorrent4j.so
${ANDROID_TOOLCHAIN}/bin/llvm-readelf -d bin/release/android/arm64-v8a/libtorrent4j.so
