...
public class request_dropped_alert extends peer_alert {
  ...
  protected static long swigRelease(request_dropped_alert obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public alert_category_t category() {
    return new alert_category_t(libtorrent_jni.request_dropped_alert_category(swigCPtr, this), true);
  }
  ...
  public final static alert_priority priority = alert_priority.swigToEnum(libtorrent_jni.request_dropped_alert_priority_get());
  public final static int alert_type = libtorrent_jni.request_dropped_alert_alert_type_get();
  public final static alert_category_t static_category = new alert_category_t(libtorrent_jni.request_dropped_alert_static_category_get(), false);
}
