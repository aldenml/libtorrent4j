...
public class dht_direct_response_alert extends alert {
  ...
  protected static long swigRelease(dht_direct_response_alert obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public alert_category_t category() {
    return new alert_category_t(libtorrent_jni.dht_direct_response_alert_category(swigCPtr, this), true);
  }
