...
public class i2p_alert extends alert {
  ...
  protected i2p_alert(long cPtr, boolean cMemoryOwn) {
    super(libtorrent_jni.i2p_alert_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }

  protected static long getCPtr(i2p_alert obj) {
    return (obj == null) ? 0 : obj.swigCPtr;
  }

  protected static long swigRelease(i2p_alert obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        libtorrent_jni.delete_i2p_alert(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
  ...
  public alert_category_t category() {
    return new alert_category_t(libtorrent_jni.i2p_alert_category(swigCPtr, this), true);
  }

  public String what() {
    return libtorrent_jni.i2p_alert_what(swigCPtr, this);
  }
