...
public class sha1_hash_udp_endpoint_pair {
  ...
  public sha1_hash_udp_endpoint_pair(sha1_hash_udp_endpoint_pair p) {
    this(libtorrent_jni.new_sha1_hash_udp_endpoint_pair__SWIG_2(sha1_hash_udp_endpoint_pair.getCPtr(p), p), true);
  }
