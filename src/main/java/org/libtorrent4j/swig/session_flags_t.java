...
public class session_flags_t {
  ...
  public session_flags_t xor_(session_flags_t other) {
    return new session_flags_t(libtorrent_jni.session_flags_t_xor_(swigCPtr, this, session_flags_t.getCPtr(other), other), true);
  }
