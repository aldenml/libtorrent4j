...
public class reopen_network_flags_t {
  ...
  public reopen_network_flags_t xor_(reopen_network_flags_t other) {
    return new reopen_network_flags_t(libtorrent_jni.reopen_network_flags_t_xor_(swigCPtr, this, reopen_network_flags_t.getCPtr(other), other), true);
  }
