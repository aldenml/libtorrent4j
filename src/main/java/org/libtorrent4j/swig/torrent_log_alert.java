...
public class torrent_log_alert extends torrent_alert {
  ...
  protected torrent_log_alert(long cPtr, boolean cMemoryOwn) {
    super(libtorrent_jni.torrent_log_alert_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }

  protected static long getCPtr(torrent_log_alert obj) {
    return (obj == null) ? 0 : obj.swigCPtr;
  }

  protected static long swigRelease(torrent_log_alert obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        libtorrent_jni.delete_torrent_log_alert(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
  ...
  public alert_category_t category() {
    return new alert_category_t(libtorrent_jni.torrent_log_alert_category(swigCPtr, this), true);
  }
