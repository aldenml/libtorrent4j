...
public class picker_flags_t {
  ...
  protected static long swigRelease(picker_flags_t obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public boolean non_zero() {
    return libtorrent_jni.picker_flags_t_non_zero(swigCPtr, this);
  }
  ...
  public picker_flags_t xor_(picker_flags_t other) {
    return new picker_flags_t(libtorrent_jni.picker_flags_t_xor_(swigCPtr, this, picker_flags_t.getCPtr(other), other), true);
  }
  ...
  public static picker_flags_t from_int(int val) {
    return new picker_flags_t(libtorrent_jni.picker_flags_t_from_int(val), true);
  }
