...
public class picker_flags_t {
  ...
  public picker_flags_t op_or(picker_flags_t other) {
    return new picker_flags_t(libtorrent_jni.picker_flags_t_op_or(swigCPtr, this, picker_flags_t.getCPtr(other), other), true);
  }

  public picker_flags_t op_and(picker_flags_t other) {
    return new picker_flags_t(libtorrent_jni.picker_flags_t_op_and(swigCPtr, this, picker_flags_t.getCPtr(other), other), true);
  }
