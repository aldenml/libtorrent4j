...
public class connection_type_t {
  ...
  public connection_type_t xor_(connection_type_t other) {
    return new connection_type_t(libtorrent_jni.connection_type_t_xor_(swigCPtr, this, connection_type_t.getCPtr(other), other), true);
  }
