...
public class resume_data_flags_t {
  ...
  public boolean non_zero() {
    return libtorrent_jni.resume_data_flags_t_non_zero(swigCPtr, this);
  }
  ...
  public resume_data_flags_t xor_(resume_data_flags_t other) {
    return new resume_data_flags_t(libtorrent_jni.resume_data_flags_t_xor_(swigCPtr, this, resume_data_flags_t.getCPtr(other), other), true);
  }
  ...
  public static resume_data_flags_t from_int(int val) {
    return new resume_data_flags_t(libtorrent_jni.resume_data_flags_t_from_int(val), true);
  }
