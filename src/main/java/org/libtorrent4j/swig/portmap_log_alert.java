...
public class portmap_log_alert extends alert {
  ...
  protected static long swigRelease(portmap_log_alert obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public alert_category_t category() {
    return new alert_category_t(libtorrent_jni.portmap_log_alert_category(swigCPtr, this), true);
  }
  ...
  public portmap_transport getMap_transport() {
    return portmap_transport.swigToEnum(libtorrent_jni.portmap_log_alert_map_transport_get(swigCPtr, this));
  }
  ...
  public final static alert_priority priority = alert_priority.swigToEnum(libtorrent_jni.portmap_log_alert_priority_get());
  public final static int alert_type = libtorrent_jni.portmap_log_alert_alert_type_get();
  public final static alert_category_t static_category = new alert_category_t(libtorrent_jni.portmap_log_alert_static_category_get(), false);
}
