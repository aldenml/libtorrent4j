...
public class posix_wrapper {
  ...
  public long opendir(String name) {
    return (getClass() == posix_wrapper.class) ? libtorrent_jni.posix_wrapper_opendir(swigCPtr, this, name) : libtorrent_jni.posix_wrapper_opendirSwigExplicitposix_wrapper(swigCPtr, this, name);
  }
