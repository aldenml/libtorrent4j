...
public class remove_flags_t {
  ...
  public remove_flags_t xor_(remove_flags_t other) {
    return new remove_flags_t(libtorrent_jni.remove_flags_t_xor_(swigCPtr, this, remove_flags_t.getCPtr(other), other), true);
  }
