...
public class file_flags_t {
  ...
  protected static long swigRelease(file_flags_t obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public boolean non_zero() {
    return libtorrent_jni.file_flags_t_non_zero(swigCPtr, this);
  }
  ...
  public file_flags_t xor_(file_flags_t other) {
    return new file_flags_t(libtorrent_jni.file_flags_t_xor_(swigCPtr, this, file_flags_t.getCPtr(other), other), true);
  }
  ...
  public static file_flags_t from_int(int val) {
    return new file_flags_t(libtorrent_jni.file_flags_t_from_int(val), true);
  }
