...
public class file_progress_flags_t {
  ...
  protected static long swigRelease(file_progress_flags_t obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public file_progress_flags_t xor_(file_progress_flags_t other) {
    return new file_progress_flags_t(libtorrent_jni.file_progress_flags_t_xor_(swigCPtr, this, file_progress_flags_t.getCPtr(other), other), true);
  }
