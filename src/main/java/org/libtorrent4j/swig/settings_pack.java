...
public class settings_pack extends settings_interface {
  ...
  public final static class bool_types {
    ...
    public final static settings_pack.bool_types proxy_send_host_in_connect = new settings_pack.bool_types("proxy_send_host_in_connect");
    public final static settings_pack.bool_types disk_disable_copy_on_write = new settings_pack.bool_types("disk_disable_copy_on_write");
  ...
  public final static class int_types {
    ...
    public final static settings_pack.int_types i2p_inbound_length_variance = new settings_pack.int_types("i2p_inbound_length_variance");
    public final static settings_pack.int_types i2p_outbound_length_variance = new settings_pack.int_types("i2p_outbound_length_variance");
