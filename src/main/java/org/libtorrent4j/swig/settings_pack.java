...
public class settings_pack extends settings_interface {
  ...
  public final static class string_types {
    ...
    private static string_types[] swigValues = { user_agent, announce_ip, handshake_client_version, outgoing_interfaces, listen_interfaces, proxy_hostname, proxy_username, proxy_password, i2p_hostname, peer_fingerprint, dht_bootstrap_nodes, webtorrent_stun_server, max_string_setting_internal };
    private static int swigNext = 0;
    private final int swigValue;
    private final String swigName;
  }
  ...
  public final static class bool_types {
    ...
    public final static settings_pack.bool_types deprecated_volatile_read_cache = new settings_pack.bool_types("deprecated_volatile_read_cache", libtorrent_jni.settings_pack_deprecated_volatile_read_cache_get());
