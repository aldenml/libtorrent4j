...
public class alert {
  ...
  public static oversized_file_alert cast_to_oversized_file_alert(alert a) {
    long cPtr = libtorrent_jni.alert_cast_to_oversized_file_alert(alert.getCPtr(a), a);
    return (cPtr == 0) ? null : new oversized_file_alert(cPtr, false);
  }

  public static torrent_conflict_alert cast_to_torrent_conflict_alert(alert a) {
    long cPtr = libtorrent_jni.alert_cast_to_torrent_conflict_alert(alert.getCPtr(a), a);
