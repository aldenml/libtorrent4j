...
public class add_piece_flags_t {
  ...
  public boolean non_zero() {
    return libtorrent_jni.add_piece_flags_t_non_zero(swigCPtr, this);
  }
  ...
  public add_piece_flags_t xor_(add_piece_flags_t other) {
    return new add_piece_flags_t(libtorrent_jni.add_piece_flags_t_xor_(swigCPtr, this, add_piece_flags_t.getCPtr(other), other), true);
  }
  ...
  public static add_piece_flags_t from_int(int val) {
    return new add_piece_flags_t(libtorrent_jni.add_piece_flags_t_from_int(val), true);
  }
