...
public class deadline_flags_t {
  ...
  protected static long swigRelease(deadline_flags_t obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public boolean non_zero() {
    return libtorrent_jni.deadline_flags_t_non_zero(swigCPtr, this);
  }
  ...
  public deadline_flags_t xor_(deadline_flags_t other) {
    return new deadline_flags_t(libtorrent_jni.deadline_flags_t_xor_(swigCPtr, this, deadline_flags_t.getCPtr(other), other), true);
  }
  ...
  public static deadline_flags_t from_int(int val) {
    return new deadline_flags_t(libtorrent_jni.deadline_flags_t_from_int(val), true);
  }
