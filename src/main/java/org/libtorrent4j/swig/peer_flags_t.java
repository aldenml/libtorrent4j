...
public class peer_flags_t {
  ...
  public peer_flags_t xor_(peer_flags_t other) {
    return new peer_flags_t(libtorrent_jni.peer_flags_t_xor_(swigCPtr, this, peer_flags_t.getCPtr(other), other), true);
  }
