...
public class peer_flags_t {
  ...
  public peer_flags_t op_or(peer_flags_t other) {
    return new peer_flags_t(libtorrent_jni.peer_flags_t_op_or(swigCPtr, this, peer_flags_t.getCPtr(other), other), true);
  }

  public peer_flags_t op_and(peer_flags_t other) {
    return new peer_flags_t(libtorrent_jni.peer_flags_t_op_and(swigCPtr, this, peer_flags_t.getCPtr(other), other), true);
  }
