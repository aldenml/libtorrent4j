...
public class bandwidth_state_flags_t {
  ...
  public bandwidth_state_flags_t xor_(bandwidth_state_flags_t other) {
    return new bandwidth_state_flags_t(libtorrent_jni.bandwidth_state_flags_t_xor_(swigCPtr, this, bandwidth_state_flags_t.getCPtr(other), other), true);
  }
