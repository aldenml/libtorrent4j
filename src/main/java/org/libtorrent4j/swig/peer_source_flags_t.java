...
public class peer_source_flags_t {
  ...
  public boolean non_zero() {
    return libtorrent_jni.peer_source_flags_t_non_zero(swigCPtr, this);
  }
  ...
  public peer_source_flags_t xor_(peer_source_flags_t other) {
    return new peer_source_flags_t(libtorrent_jni.peer_source_flags_t_xor_(swigCPtr, this, peer_source_flags_t.getCPtr(other), other), true);
  }
  ...
  public static peer_source_flags_t from_int(int val) {
    return new peer_source_flags_t(libtorrent_jni.peer_source_flags_t_from_int(val), true);
  }
