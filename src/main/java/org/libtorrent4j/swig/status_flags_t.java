...
public class status_flags_t {
  ...
  public status_flags_t xor_(status_flags_t other) {
    return new status_flags_t(libtorrent_jni.status_flags_t_xor_(swigCPtr, this, status_flags_t.getCPtr(other), other), true);
  }
  ...
  public static status_flags_t from_int(int val) {
    return new status_flags_t(libtorrent_jni.status_flags_t_from_int(val), true);
  }
