...
public class pex_flags_t {
  ...
  protected static long swigRelease(pex_flags_t obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public boolean non_zero() {
    return libtorrent_jni.pex_flags_t_non_zero(swigCPtr, this);
  }
  ...
  public pex_flags_t xor_(pex_flags_t other) {
    return new pex_flags_t(libtorrent_jni.pex_flags_t_xor_(swigCPtr, this, pex_flags_t.getCPtr(other), other), true);
  }
  ...
  public static pex_flags_t from_int(int val) {
    return new pex_flags_t(libtorrent_jni.pex_flags_t_from_int(val), true);
  }
