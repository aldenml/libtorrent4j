...
public class peer_unsnubbed_alert extends peer_alert {
  ...
  protected static long swigRelease(peer_unsnubbed_alert obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public final static alert_priority priority = alert_priority.swigToEnum(libtorrent_jni.peer_unsnubbed_alert_priority_get());
