...
public final class operation_t {
  ...
  public final static operation_t file_mmap = new operation_t("file_mmap");
  public final static operation_t file_truncate = new operation_t("file_truncate");
