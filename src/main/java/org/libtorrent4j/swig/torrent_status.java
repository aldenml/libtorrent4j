...
public class torrent_status {
  ...
  public final static class state_t {
    ...
    public final static torrent_status.state_t downloading = new torrent_status.state_t("downloading", libtorrent_jni.torrent_status_downloading_get());
    public final static torrent_status.state_t finished = new torrent_status.state_t("finished", libtorrent_jni.torrent_status_finished_get());
    public final static torrent_status.state_t seeding = new torrent_status.state_t("seeding", libtorrent_jni.torrent_status_seeding_get());
