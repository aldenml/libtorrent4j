...
public class pause_flags_t {
  ...
  public pause_flags_t op_or(pause_flags_t other) {
    return new pause_flags_t(libtorrent_jni.pause_flags_t_op_or(swigCPtr, this, pause_flags_t.getCPtr(other), other), true);
  }

  public pause_flags_t op_and(pause_flags_t other) {
    return new pause_flags_t(libtorrent_jni.pause_flags_t_op_and(swigCPtr, this, pause_flags_t.getCPtr(other), other), true);
  }
