...
public class dht_immutable_item_alert extends alert {
  ...
  protected static long swigRelease(dht_immutable_item_alert obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public alert_category_t category() {
    return new alert_category_t(libtorrent_jni.dht_immutable_item_alert_category(swigCPtr, this), true);
  }
  ...
  public entry getItem() {
    long cPtr = libtorrent_jni.dht_immutable_item_alert_item_get(swigCPtr, this);
