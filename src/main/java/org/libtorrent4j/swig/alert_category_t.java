...
public class alert_category_t {
  ...
  public boolean non_zero() {
    return libtorrent_jni.alert_category_t_non_zero(swigCPtr, this);
  }
  ...
  public alert_category_t xor_(alert_category_t other) {
    return new alert_category_t(libtorrent_jni.alert_category_t_xor_(swigCPtr, this, alert_category_t.getCPtr(other), other), true);
  }
