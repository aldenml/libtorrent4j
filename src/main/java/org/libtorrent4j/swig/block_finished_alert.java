...
public class block_finished_alert extends peer_alert {
  ...
  protected static long swigRelease(block_finished_alert obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public alert_category_t category() {
    return new alert_category_t(libtorrent_jni.block_finished_alert_category(swigCPtr, this), true);
  }

  public String what() {
    return libtorrent_jni.block_finished_alert_what(swigCPtr, this);
  }
  ...
  public final static alert_priority priority = alert_priority.swigToEnum(libtorrent_jni.block_finished_alert_priority_get());
  public final static int alert_type = libtorrent_jni.block_finished_alert_alert_type_get();
  public final static alert_category_t static_category = new alert_category_t(libtorrent_jni.block_finished_alert_static_category_get(), false);
}
